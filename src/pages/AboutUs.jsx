            ...
            <div className="container">
                ...
                <section className="icon-info section">
                    <div className="icon-info__column">
                        <img className="icon-info__img" src={laptop_icon} alt=""/>
                        <p className="icon-info__count">2</p>
                        <p className="icon-info__subtitle">Кількість комп'ютерів</p>
                    </div>
                    <div className="icon-info__column">
                        <img className="icon-info__img" src={library_size_icon} alt=""/>
                        <p className="icon-info__count">75 M2</p>
                        <p className="icon-info__subtitle">Площа бібліотеки</p>
                    </div>
                    <div className="icon-info__column">
                        <img className="icon-info__img" src={reader_icon} alt=""/>
                ...
                <section className="about-info section">
                    ...
                    <img src={library_img1} id="library-photo-1" alt="library"/>
                ...
                <section className="main-info section">
                    <div className="main-info__column">
                        ...
                        <p className="main-info__text"><img className="main-info__img" src={house_icon} alt=""/><b>Населений пункт: </b>Кавсько</p>
                        <p className="main-info__text"><img className="main-info__img" src={map_icon} alt=""/><b>Область: </b>Львівська</p>
                        <p className="main-info__text"><img className="main-info__img" src={mail_icon} alt=""/><b>Поштовий індекс: </b>82420</p>
                        <p className="main-info__text"><img className="main-info__img" src={map_pin_icon} alt=""/><b>Адреса: </b>вул.Польова,4</p>
                    </div>
                    <div className="main-info__column">
                        <p className="main-info__title">Контактні дані</p>
                        <p className="main-info__text"><img className="main-info__img" src={phone_icon} alt=""/><b>Телефон:</b> (03245)38559</p>
                    </div>
                    <div className="main-info__column">
                        <p className="main-info__title">Ми в соціальних мережах</p>
                        <p className="main-info__text"><img className="main-info__img" src={fasebook_icon} alt="" /><b>Facebook:</b><a className="main-info__link" href="https://www.facebook.com/groups/2042168039352010/about" target="_blank" rel="noreferrer"> Бібліотека с.Кавсько</a></p>
                    </div>
                </section>
            </div>
        </div>
